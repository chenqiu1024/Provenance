...
struct Constants {
    struct iCloud {
        static let containerIdentifier = "iCloud.com.cyllenge.provenance"
...
public final class GameImporter {
    ...
    public private(set) var serialImportQueue: OperationQueue = {
        ...
        queue.name = "com.cyllenge.provenance.serialImportQueue"
    ...
    lazy var openVGDB: OESQLiteDatabase = {
        let bundle = Bundle(identifier: "com.cyllenge.PVLibrary")!
...
public extension GameImporter {
    ...
    func lookupInfo(for game: PVGame, overwrite: Bool = true) {
        let database = RomDatabase.sharedInstance
        database.refresh()
